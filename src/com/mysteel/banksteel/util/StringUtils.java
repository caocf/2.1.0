...
public abstract class StringUtils
{
	...
	/*
	 * public static String b2q(String str) { str = StringUtils.nullSafe(str);
	 * 
	 * if (str.indexOf("\"") != -1 || str.indexOf("'") != -1) { int isq = 0; int
	 * idq = 0;
	 * 
	 * for (int i = 0; i < str.length(); i++) { if (str.charAt(i) == '\'') {
	 * isq++;
	 * 
	 * if (isq % 2 == 0) { str = str.replaceFirst("'", "��"); } else { str =
	 * str.replaceFirst("'", "��"); } } else if (str.charAt(i) == '\"') { idq++;
	 * 
	 * if (idq % 2 == 0) { str = str.replaceFirst("\"", "��"); } else { str =
	 * str.replaceFirst("\"", "��"); } } } }
	 * 
	 * return str; }
	 */
