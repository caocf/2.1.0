...
public class Patterns
{
	...
	public static final Pattern PHONE = Pattern
			.compile("13\\d{9}||14\\d{9}||15\\d{9}||17\\d{9}||18\\d{9}$");
	 ...
	 * 用户名检测
	 */
	public static final Pattern USER_NAME = Pattern
			.compile("^[[a-zA-Z0-9_\u4e00-\u9fa5]+$]{2,16}");
	/**
	 * 身份证开户姓名，只能是中文 不科学 ·
	 */
	public static final Pattern BIND_CARD_NAME = Pattern
			.compile("[\\u4e00-\\u9fa5·]+");

	/** 包含中文判断. */
	public static final Pattern PWD_CHINESE = Pattern
			.compile("[\u4e00-\u9fa5]");
	...
	public static final Pattern ISNUMBERS = Pattern
			.compile("^\\d{1,5}(\\.\\d{1,2})?$");
}
