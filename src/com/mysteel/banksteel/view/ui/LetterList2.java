...
public class LetterList2 extends View
{
	...
	public LetterList2(Context context, AttributeSet attrs, int defStyle)
	{
		super(context, attrs, defStyle);
	}

	public LetterList2(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	}

	public LetterList2(Context context)
	{
		super(context);
	}
