...
import com.mysteel.banksteel.view.adapters.ScreeningCaizhiAdapter;
 ...
 */
public class ScreeningCaizhiActivity extends BaseDialogActivity implements
IListViewInterface, IXListViewListener, IBuyView{
		...
		private ScreeningCaizhiAdapter adapter;
...
//	        p.width = (int) (d.getWidth() * 0.7);    //宽度设置为屏幕的0.8   
		...
		private void initData()
		{
			...
			adapter = new ScreeningCaizhiAdapter(mContext, null);
			...
			ll_all.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					EventBus.getDefault().post("", "screening3activity");
					finish();
				}
			});
			...
			lv_listview.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
					EventBus.getDefault().post(list.get(position-1), "screening3activity");
					finish();
				}
			});
